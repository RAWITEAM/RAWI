...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./RAWI.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("RA", "w")  
...
sudo_users = {SUDO,854117788,887280994,1033028167}   
...
if hash or SudoBot(msg) or DevRAWIW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevRAWIW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevRAWIW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevRAWIW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevRAWIW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevRAWIW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevRAWIW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "wimg_1")
...
RAWI_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
RAWI_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
RAWI_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
RAWI_Msg = 'امبروطور التفاعل' 
...
--------------------------------------------------------------------------------------------------------------
function SourceRAWI(msg,data) -- بداية العمل
if msg then
...
SourceRAWIr = '❃∫ اهلا عزيزي\n ❃∫ انا بوت اسمي '..Namebot..'\n ❃∫ اختصاصي حمايه الكروبات\n ❃∫ من تكرار والسبام والتوجيه والخ…\n ❃∫ لتفعيلي اتبع الاخطوات…↓\n ❃∫ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ❃∫ [قناة سورس البوت](http://t.me/wimg_1)'
end 
send(msg.chat_id_, msg.id_, SourceRAWIr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevRAWIW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevRAWIW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,RAWI_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❃' and DevRAWIW(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevRAWIW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevRAWIW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevRAWIW(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevRAWIW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❃∫ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❃' and DevRAWIW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevRAWIW(msg) then 
...
if text == 'تحديث السورس ❃' and DevRAWIW(msg) then 
os.execute('rm -rf RAWI.lua')
os.execute('wget https://raw.githubusercontent.com/RAWITEAM/RAWI/main/RAWI.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس راوي\n ❃∫ الاصدار » { 1.3v}')
dofile('RAWI.lua')  
end
if text == 'الاصدار ❃' and DevRAWIW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس راوي \n ❃∫ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ❃' and DevRAWIW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/ASD200K) \n ❃∫ [قناه السورس](t.me/wimg_1)')
end
if text == "ضع اسم للبوت ❃" and DevRAWIW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❃' and DevRAWIW(msg) then 
...
if text == 'المشتركين ❃' and DevRAWIW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ❃' and DevRAWIW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevRAWIW(msg) then
...
if text == ("قائمه العام ❃") and DevRAWIW(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevRAWIW(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevRAWIW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevRAWIW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevRAWIW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevRAWIW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevRAWIW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❃' and DevRAWIW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❃" and DevRAWIW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ❃" and DevRAWIW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الكروبات الان » { '..#group..' }'..RAWIk..''..RAWI..'\n❃∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevRAWIW(msg) then
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'wimg_1')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevRAWIW(msg) then
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'wimg_1')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevRAWIW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevRAWIW(msg) then
...
local RAWI1_Msg = database:get(bot_id.."RAWI1:Add:Filter:Rp2"..text..msg.chat_id_)   
if RAWI1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'wimg_1')..') \n ❃∫ '..RAWI1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if RAWI_Msg and not Special(msg) then  
local RAWI_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if RAWI_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..RAWI_Msg.."] \n")
else
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/wimg_1)}\n ❃∫ ["..RAWI_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/wimg_1)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevRAWIW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevRAWIW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevRAWIW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevRAWIW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❃" and DevRAWIW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❃∫ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevRAWIW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevRAWIW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❃" and DevRAWIW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❃∫ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❃" and DevRAWIW(msg) then  
...
database:sadd(bot_id.."RAWI:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."RAWI:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_RAWI = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_RAWI then 
names_RAWI = database:smembers(bot_id.."RAWI:blocname"..msg.chat_id_) or ""
if names_RAWI and names_RAWI[1] then 
for i=1,#names_RAWI do 
if name_RAWI:match("(.*)("..names_RAWI[i]..")(.*)") then 
...
database:set(bot_id.."RAWI:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."RAWI:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."RAWI:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."RAWI:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."RAWI:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_RAWIa_new(RAWI1,RAWI2)
if RAWI2 and RAWI2.first_name_ then 
if RAWI2.first_name_:match("(.*)"..database:get(bot_id.."RAWI:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."RAWI:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local RAWI_nnn = database:get(bot_id.."RAWI:nump"..msg.chat_id_) or 5
local RAWI_nnn2 = database:get(bot_id.."RAWI:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(RAWI_nnn2) == tonumber(RAWI_nnn) or tonumber(RAWI_nnn2) > tonumber(RAWI_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."RAWI:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❃∫ عزيزي >>["..RAWI2.username_.."](https://t.me/"..(RAWI2.username_ or "wimg_1")..")\n❃∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."RAWI:teh"..msg.chat_id_).."} بجانب اسمك\n❃∫ عدد المحاولات المتبقيه {"..(tonumber(RAWI_nnn) - tonumber(RAWI_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_RAWIa_new)
end
end
...
local RAWIChengName = database:get(bot_id.."RAWI:Cheng:Name"..data.id_)
if not data.first_name_ then 
if RAWIChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..RAWIChengName..']')
database:del(bot_id.."RAWI:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if RAWIChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."RAWI:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local RAWIChengUserName = database:get(bot_id.."RAWI:Cheng:UserName"..data.id_)
if not data.username_ then 
if RAWIChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..RAWIChengUserName..']')
database:del(bot_id.."RAWI:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if RAWIChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."RAWI:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local RAWIChengPhoto = database:get(bot_id.."RAWI:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if RAWIChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."RAWI:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if RAWIChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."RAWI:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
≪━━━━━━𝗥𝗔━━━━━━≫
 ❃∫ ↬𝗥𝗔𝗪𝗜 𝗧𝗘𝗔𝗠
≪━━━━━━𝗥𝗔━━━━━━≫
 ❃∫ ↬[Channel RAWI](t.me/wimg_1) 
≪━━━━━━𝗥𝗔━━━━━━≫
 ❃∫ ↬[Information](t.me/ASD200K)
≪━━━━━━𝗥𝗔━━━━━━≫
 ❃∫ ↬[DEVELOPER](t.me/SS_199Z)
≪━━━━━━𝗥𝗔━━━━━━≫
 ❃∫ ↬[To talk to us](t.me/saifalriwi_bot)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == 'رفع نسخه الاحتياطيه' and DevRAWIW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'wimg_1')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'wimg_1')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevRAWIW(msg) then    
dofile('RAWI.lua')  
send(msg.chat_id_, msg.id_, ' ❃∫ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevRAWIW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevRAWIW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevRAWIW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevRAWIW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevRAWIW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevRAWIW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevRAWIW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevRAWIW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevRAWIW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevRAWIW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevRAWIW(msg) then
...
if text == 'الملفات' and DevRAWIW(msg) then
t = ' ❃∫ ملفات السورس راوي ↓\n≪━━━━━━𝗥𝗔━━━━━━≫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevRAWIW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/RAWITEAM/Files_RAWI/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات راوي\n ❃∫ ملفات السورس ↓\n≪━━━━━━𝗥𝗔━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝗥𝗔━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس راوي ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/wimg_1) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevRAWIW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/RAWITEAM/Files_RAWI/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('RAWI.lua')  
else
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس راوي \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevRAWIW(msg) then
...
if text == "مسح الملفات" and DevRAWIW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ❃∫ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevRAWIW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevRAWIW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "wimg_1")
...
function Function_RAWI(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_RAWI, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_RAWI, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'wimg_1')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'wimg_1')..')'
...
database:set(bot_id.."RAWI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."RAWI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."RAWI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."RAWI1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."RAWI1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."RAWI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."RAWI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."RAWI1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."RAWI1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."RAWI1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."RAWI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."RAWI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."RAWI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."RAWI1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."RAWI1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."RAWI1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."RAWI1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."RAWI1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."RAWI1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━𝗥𝗔━━━━━━≫\n"
for k,v in pairs(list) do  
local RAWI_Msg = database:get(bot_id.."RAWI1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..RAWI_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevRAWIW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ❃∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevRAWIW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'wimg_1')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevRAWIW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevRAWIW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'راوي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'راوي')
local RAWI_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..RAWI_Msg[math.random(#RAWI_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevRAWIW(msg) then 
...
if text == ("مسح ردود المطور") and DevRAWIW(msg) then 
...
if text == ("ردود المطور") and DevRAWIW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❃∫ قائمة ردود المطور \n≪━━━━━━𝗥𝗔━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevRAWIW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevRAWIW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'راوي').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevRAWIW(msg) then   
...
if text == 'تعطيل المغادره' and DevRAWIW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'RAWI')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'wimg_1')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
RAWIdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevRAWIW(msg) then
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━𝗥𝗔━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[𝗥𝗔 𝗧𝗘𝗔𝗠](t.me/wimg_1)➢ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'راوي')
...
RAWI = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(RAWI)
...
------------------------------------------------------------------------
local RAWIAbot = database:get(bot_id.."RAWI1:Add:Filter:Rp2"..text..result.chat_id_)   
if RAWIAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..RAWIAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local RAWI1_Msg = database:get(bot_id.."RAWI1:Add:Filter:Rp2"..text..result.chat_id_)   
if RAWI1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..RAWI1_Msg)
